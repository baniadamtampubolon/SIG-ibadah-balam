...
# Model data disesuaikan dengan tabel database
...
def index():
    try:
        ...
        return render_template('index.html', points=json.dumps(geojson))
    
    except Exception as e:
        print(f"Error: {str(e)}")
        return render_template('index.html', points=json.dumps({'type': 'FeatureCollection', 'features': []}))
